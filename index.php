            ...
            <nav>
                <div class="row">
                    ...
                    <ul class="main-nav js--main-nav">
                        <li><a href="#features">Food deliver</a></li>
                ...
                <div class="col span-1-of-3">
                    <div class="plan-box js--wp-4">
                        ...
                        <div>
                            <ul>
                                <li>
                                    <i class="icon ion-ios-checkmark icon-small"></i>
                                    1 meal every day
                                </li>
                                <li>
                                    <i class="icon ion-ios-checkmark icon-small"></i>
                    ...
                    <div class="plan-box">
                        ...
                        <div>
                            <ul>
                                ...
                                <li>
                                    <i class="icon ion-ios-close icon-small"></i>
                                </li>
                                <li>
                                    <i class="icon ion-ios-checkmark icon-small"></i>
                                    Free delivery
                ...
                <form method="post" action="mailer-new.php" class="contact-form">
                    <div class="row">
                        ...
                        <?php
                            ...
                            if($_GET['success'] == -1) {
                                echo "<div class=\"form-messages error\">Thank you! Your message has been sent.</div>";
                            }
                        ?>
                    </div>
